...
public class TipoSocioControllerTest {
    ...
    public void buscarPorId_CuandoExiste_DeberiaRetornarTipo() throws Exception {
        ...
        when(tipoSocioService.obtenerTipoSocioPorId(1)).thenReturn(tipo);
    ...
    public void buscarPorId_CuandoNoExiste_DeberiaRetornar404() throws Exception {
        when(tipoSocioService.obtenerTipoSocioPorId(99))
                .thenThrow(new ResourceNotFoundException("Tipo de socio no encontrado"));
    ...
    @Test
    @DisplayName("DELETE /api/v1/tipos-socio/{id} -> Retorna 200 aunque el ID no exista")
    public void eliminar_CuandoNoExiste_DeberiaRetornar200() throws Exception {
        doNothing().when(tipoSocioService).eliminarTipoSocio(99);
